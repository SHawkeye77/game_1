"""
This was found at https://github.com/jezhiggins/eliza.py/blob/master/eliza.py
and I have made minor adjustments.



Works by reading in the "doctor.txt" text using the words and tags from that in 
...
class Eliza:
    ...
    def run(self):
        ...
        while True:
            sent = input('What do you say? (say goodbye to quit) ')
...
def main():
    eliza = Eliza()
    eliza.load('./resources/eliza/doctor.txt')
    eliza.run()
