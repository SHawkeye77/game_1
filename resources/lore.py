...
NOTE: Be sure none of the names from here or from imported strings overlap.
"""

from resources.computer_text import *
...
CONCLUSION_TEXT = "SUCCESS" \
                  "Created by: Samuel Hohenshell" \
                  "\nSpecial thanks to:" \
                  "\nOwen Murphy for the help and for not telling my boss I worked on this at work" \
                  "\nPeter Schmidt for the wonderful additions to the storyline" \
                  "\nAnn and Jeffrey Hohenshell for input on description creation" \
                  "\nTim Anderson, Bruce Daniels, Dave Lebling, and Marc Blank for the inspiration :)"  # Zork creators
